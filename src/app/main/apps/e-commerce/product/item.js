        ...
        content={
          <>
            ...
            >
              ...
              <Tab className="h-64" label="Unit Classification" />
              <Tab className="h-64" label="Images" />
              <Tab className="h-64" label="Technical Details" />
              <Tab className="h-64" label="Additional Details" />
              <Tab className="h-64" label="Safety Information:" />
              <Tab className="h-64" label="Legal Disclaimer:" />
              <Tab className="h-64" label="Related Products:" />
