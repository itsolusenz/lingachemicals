...
import ProductHeader from './brandHeader';
import BasicInfoTab from './brandtabs/BasicInfoTab';
     ...
     return (
       ...
       >
         <Typography color="text.secondary" variant="h5">
           There is no such users!
         </Typography>
         <Button
           className="mt-24"
           component={Link}
           variant="outlined"
           to="/apps/e-commerce/user"
           color="inherit"
         >
           Go to Tax Page
         </Button>
        ...
        content={
          <>
            ...
            >
              ...
              <Tab className="h-64" label="Registration" />
              <Tab className="h-64" label="Social" />
