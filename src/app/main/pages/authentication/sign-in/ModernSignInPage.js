      ...
      <Paper className="flex w-full sm:w-auto min-h-full sm:min-h-auto md:w-full md:max-w-6xl rounded-0 sm:rounded-2xl sm:shadow overflow-hidden">
        ...
        >
          ...
          <div className="z-10 relative w-full max-w-2xl">
            ...
            Laabamone business solution is a leading software developing company 
            situated in Madurai.High achievement always takes place in the framework of high expectation.
            </div>
            {/* <div className="flex items-center mt-32">
              <AvatarGroup
                sx={{
